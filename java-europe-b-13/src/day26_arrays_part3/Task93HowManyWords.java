...
public class Task93HowManyWords {

	public static void main(String[] args) {
		String str = "As he crossed toward the pharmacy at the corner he involuntarily turned his head because of a "
				+ "burst of light that had ricocheted from his temple, and saw, with that quick smile with which we greet a "
				+ "rainbow or a rose, a blindingly white parallelogram of sky being unloaded from the van—a "
